<div class="navbar-header" style="background: #1c2134;">
    <div class="d-flex">
        ...
        <div class="navbar-brand-box">
            <a href="{{url('admin')}}" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="https://cdn-fohja.nitrocdn.com/OeyrJiRykLEPVhCTzfTUfQuMvKHJwvkf/assets/static/optimized/rev-d6548d0/wp-content/uploads/2022/02/Untitled-design-8-300x150.png" alt="" height="22">
                </span>
                <span class="logo-lg">
                    <img src="https://cdn-fohja.nitrocdn.com/OeyrJiRykLEPVhCTzfTUfQuMvKHJwvkf/assets/static/optimized/rev-d6548d0/wp-content/uploads/2022/02/Untitled-design-8-300x150.png" alt="" height="17">
                </span>
            </a>
            ...
            <a href="{{url('admin')}}" class="logo logo-light">
                ...
                <span class="logo-lg">
                    <img src="https://cdn-fohja.nitrocdn.com/OeyrJiRykLEPVhCTzfTUfQuMvKHJwvkf/assets/static/optimized/rev-d6548d0/wp-content/uploads/2022/02/Untitled-design-8-300x150.png" alt="" style="width: 60%;height:70px" height="17">
                </span>
            </a>
        </div>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-none d-md-block">
            <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="me-2" src='{{asset("uploads/flags/$flags->flag")}}' alt="Header Language" height="16"> {{$flags->languageTitle}} <span class="mdi mdi-chevron-down"> </span>
            </button>
            <div class="dropdown-menu dropdown-menu-end">
                @foreach($langs as $lang)
                <!-- item-->
                <a href='{{route("languages.submitLang",$lang->id)}}' class="dropdown-item notify-item">
                    <img src='{{asset("uploads/flags/$lang->flag")}}' alt="user-image" class="me-1" height="12"> <span class="align-middle"> {{$lang->languageTitle}} </span>
                </a>
                @endforeach
                <!--  -->
